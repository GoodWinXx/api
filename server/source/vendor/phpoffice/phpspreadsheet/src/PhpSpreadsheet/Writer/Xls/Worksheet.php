...
//        if ($this->firstColumnIndex > 255) $this->firstColumnIndex = 255;
    ...
    public function writeUrlExternal($row1, $col1, $row2, $col2, $url)
    {
        ...
        // Outlet the short dos dir name (null terminated)
        $dir_short = preg_replace('/\\.\\.\\\\/', '', $dir_long) . "\0";

        // Outlet the long dir name as a wchar string (non-null terminated)
        $dir_long = $dir_long . "\0";
    ...
    /**
     * Outlet the MERGEDCELLS records for all ranges of merged cells.
     */
    ...
    /**
     * Outlet the page setup SETUP BIFF record.
     */
    ...
    /**
     * Outlet the header caption BIFF record.
     */
    ...
    /**
     * Outlet the footer caption BIFF record.
     */
    ...
    /**
     * Outlet the horizontal centering HCENTER BIFF record.
     */
    ...
    /**
     * Outlet the vertical centering VCENTER BIFF record.
     */
    ...
    /**
     * Outlet the LEFTMARGIN BIFF record.
     */
    ...
    /**
     * Outlet the RIGHTMARGIN BIFF record.
     */
    ...
    /**
     * Outlet the TOPMARGIN BIFF record.
     */
    ...
    /**
     * Outlet the BOTTOMMARGIN BIFF record.
     */
    ...
    /**
     * Outlet the OBJ record that precedes an IMDATA record. This could be generalise
    ...
    /**
     * Outlet the window zoom factor. This should be a reduced fraction but for
    ...
    /**
     * Outlet the DATAVALIDATIONS and DATAVALIDATION records.
     */
